...
public class MemberController {
    ...
    public ApiResponse<Void> updateNickname(@AuthUser Long memberId,
    ...
    public ApiResponse<String> updateProfileImage(@AuthUser Long memberId,
                                                  @ModelAttribute MemberRequestDTO.updateProfileImageRequestDTO request) {
    ...
    public ApiResponse<MemberResponseDTO.MemberReviewListDTO> getMemberReview(@AuthUser Long memberId,
                                                                              @RequestParam("pageNumber") @Min(0) @NotNull Integer pageNumber) {
    ...
    public ApiResponse<MemberResponseDTO.MemberUpdateListDTO> getMemberUpdate(@AuthUser Long memberId,
                                                                              @RequestParam("pageNumber") @Min(0) @NotNull Integer pageNumber) {
